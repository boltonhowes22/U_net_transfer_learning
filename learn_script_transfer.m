...
training_im_ds = imageDatastore("/scratch/network/dulrich/training/*in_*.tif");
training_label_ds = pixelLabelDatastore("/scratch/network/dulrich/training/*out_*.tif", colorLabels, colorIDs);
training_ds = pixelLabelImageDatastore(training_im_ds,training_label_ds);

val_im_ds = imageDatastore("/scratch/network/dulrich/training/*_in.tif");
val_label_ds = pixelLabelDatastore("/scratch/network/dulrich/training/*_out.tif", colorLabels, colorIDs);
